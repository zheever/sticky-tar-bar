...
var Gesture = function (_Component) {
    ...
    _createClass(Gesture, [{
        ...
        value: function render() {
            ...
            return React.cloneElement(child, _extends$1({}, events, { style: _extends$1({ touchAction: touchAction }, child.props.style || {}) }));
        }
    }]);
      ...
      return React.createElement(
        ...
        function (_ref) {
          ...
          return React.createElement(
            ...
            renderTabs ? renderTabs(props) : React.createElement(_Tabs.DefaultTabBar, props)
          );
        }
      );
    }
